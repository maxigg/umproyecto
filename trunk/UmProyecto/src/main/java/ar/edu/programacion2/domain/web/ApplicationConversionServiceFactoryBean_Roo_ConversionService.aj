...
import ar.edu.programacion2.domain.web.ApplicationConversionServiceFactoryBean;
    ...
    public Converter<Usuario, String> ApplicationConversionServiceFactoryBean.getUsuarioToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<ar.edu.programacion2.domain.domain.Usuario, java.lang.String>() {
            public String convert(Usuario usuario) {
                return new StringBuilder().append(usuario.getNombre()).append(' ').append(usuario.getApellido()).append(' ').append(usuario.getUsuario()).append(' ').append(usuario.getPassword()).toString();
            }
        };
    }
